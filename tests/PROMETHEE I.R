...
# Matrix P containing preference relations between alternatives, matrix I containing indifference relations between alternatives and matrix R containing incomparability relations between alternatives

PROMETHEEI(EvaluationTable, PreferenceFunction,PreferenceThreshold,IndifferenceThreshold,GaussParameter,CriteriaWeights,CriteriaMinMax)